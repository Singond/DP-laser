...
#+RESULTS[40d04911ac41bd791774fdfd9ca200efdf20e216]:
...
#+begin_src octave :exports results :results output file link :file results/vertical.png
	<<common>>
	vertical;
	figure(1, "visible", "off");
	clf;
...
#+RESULTS[e27416f20533f7060a54e252a9b67b1ab33e2a08]:
