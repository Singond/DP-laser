...
# ╔═╡ 278cf3ab-b581-4190-a531-4038e5edb44c
using LaTeXStrings
...
begin
	scatter(Ud, Ecalib, markersize = 8, legend = :topleft, label = "naměřená data")
	plot!(calib, color = 1, label = "modelová funkce")
end

# ╔═╡ 8f7bc25a-b74a-4e94-94a7-6e7bf0b312cf


# ╔═╡ e8038603-b4cf-458b-80f0-54d7669ff86a
...
#begin
#	β_old = β
#	model(U, β) = β[1]*(U + β[2])^2
#	β_0 = (β_old[1], β_old[2]/(2*β_old[1]))
#	β = curve_fit(model, Ud, Ecalib, β_0)
#end
...
[[deps.ImportKeysightBin]]
git-tree-sha1 = "054f43df4f0c1695528126b08711248839afbd6d"
uuid = "76a68121-5bb9-42aa-bb53-85bca5455360"
version = "0.1.2"
