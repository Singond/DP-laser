...
neboť atomová spektra jsou jednodušší, nezávislá na teplotě
a~leží blízko oblasti viditelného světla.
To je podstatný rozdíl oproti spektrům molekulovým,
která jsou tvořena složitou strukturou vibračních a~rotačních přechodů
ležících v~infračervené a~mikrovlnné oblasti a~navíc závisí na teplotě.
