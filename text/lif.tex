...
\begin{figure}[p]
	\makebox[\linewidth][c]{%
		\input{../lif/results/timeev-5.0}%
		\input{../lif/results/timeev-5.5}
	}
	\makebox[\linewidth][c]{%
		\input{../lif/results/timeev-6.0}%
		\input{../lif/results/timeev-7.0}
	}
	\makebox[\linewidth][c]{%
		\input{../lif/results/timeev-10.0}%
		\input{../lif/results/timeev-12.0}
	}
