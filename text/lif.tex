...
odpovídajících jednotlivým snímkům.
Rozmístění těchto časových intervalů bylo odhadnuto ze~známé spoušťové
frekvence, počtu akumulací a~prodlevy mezi snímky.
