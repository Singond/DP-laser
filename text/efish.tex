...
Na tento pokus navázala další prací M.~Mrkvičková a~ještě před dokončením
této diplomové práce výsledky publikovala v~článku \cite{efish-nitrogen},
...
\begin{figure}[htp]
	...
	\vspace{24pt}
	\input{../efish/results/period-overview-period-small}
...
ze vztahu~\eqref{eq:efishth-ity}
...
Laser byl nastaven na energii pulzu kolem \SI{3.9}{\milli\joule}
(podle pyroelektrického měřiče).
